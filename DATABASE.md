...
восстановление пароля и вход клиента. Реализована (миграции `0030_user-tokens`,
`0035_client-account`).
...
| purpose    | enum                 | `email_verification`, `password_reset`, `client_sign_in`                |
...
Одна таблица на три случая, а не три почти одинаковых: жизненный цикл общий —
