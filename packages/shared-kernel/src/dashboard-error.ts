...
export const DASHBOARD_ERROR_CODES = {
  ...
  /**
   * У соло-мастера команды нет — звать в неё некого и некуда.
   *
   * Решение владельца продукта от 2026-09-11: соло и салон — разные кабинеты,
   * а не один, раскрывающийся со вторым человеком. Отказ стоит и при выпуске
   * приглашения, и при его приёме.
   */
  teamSoloOrganization: 'team_solo_organization',
