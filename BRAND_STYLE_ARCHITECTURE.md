...
export const BRAND_STYLE_KEYS = [
  ...
  'aura',
  'funk',
] as const; // девять ключей → семь композиций (§14.2, M8 + авторские миры)
...
**AURA и FUNK — не члены брендовой шестёрки.** Коллекция §3 закрыта
решением M8 и этим приростом не открывается. Оба мира пришли в продукт
