...
export const auditLog = pgTable(
  ...
  (table) => [
    /* Журнал открывается страницами, новыми сверху, и растёт быстрее всех
       остальных таблиц: без индекса и сортировка, и `count(*)` на каждой
       странице означали полный проход. */
