 ...
 *
 * Один период не рисуется вовсе. Линия из одной точки — неправда о ряде, но
 * и одинокая точка у левого края пустой полосы неправдой быть не перестала:
 * читается она не как «данных на один срок», а как недорисованный график.
 * Ряд начинается с двух значений — до тех пор о динамике говорит подпись
 * плитки («первый период с доходом»), и говорит она это словами.
 */
