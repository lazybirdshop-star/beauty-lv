            ...
            >
              ...
              <span
                className={cn(
                  ...
                  /*
                   * Ряд идёт вторым цветом, «сейчас» — чернилами.
                   *
                   * Розовым ряд красить нельзя дважды: во-первых, это цвет
                   * действия и занятого времени, и в ведущей ячейке двенадцать
                   * розовых столбиков занимают треть экрана, забирая роль себе;
                   * во-вторых, прозрачностью его не приглушить — #E2568A на
                   * белом даёт 3.54:1, а на 65% всего 2.26:1, ниже даже
                   * нетекстового порога 3:1.
                   *
                   * Лиловый взят ровно на эту роль — итоги, которые читают, но
                   * по которым не действуют сейчас: 4.69:1 на белой ячейке и
                   * 6.0:1 на чернильной. «Сейчас» остаётся чернильным, чтобы
                   * читаться на любой заливке, включая лиловую.
                   */
                  isCurrent ? 'bg-support-strong' : 'bg-support',
                  'transition-colors duration-[var(--dur-hover)] ease-[var(--ease-style)] group-hover:bg-support-strong',
                )}
