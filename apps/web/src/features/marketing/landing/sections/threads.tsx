...
import { DmPlayer } from '../components/dm-player';
    ...
    <section className="threads" id="threads">
      <Reveal className="frame threads__panel" as="div">
        ...
        <div className="dm rise" style={{ '--d': '300ms' } as CSSProperties}>
          ...
          {/* Переписка проигрывается как живая: «печатает…», пауза, сообщение.
              Без JS и при reduced motion разметка стоит целиком и сразу. */}
          <DmPlayer t={t} />
        </div>
      </Reveal>
    </section>
