...
export function actionLabel(action: string, t: Messages): string {
  const labels: Record<string, string> = {
    ...
    'booking.rescheduled_by_master': t.admin.logBookingRescheduled,
    'booking.rescheduled_by_client': t.admin.logBookingRescheduled,
    'booking.cancelled_by_client': t.admin.logBookingCancelled,
    'team.invited': t.admin.logTeamInvited,
    'team.invite_revoked': t.admin.logTeamInviteRevoked,
    'team.invite_accepted': t.admin.logTeamInviteAccepted,
