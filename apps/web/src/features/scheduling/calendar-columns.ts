...
export function resolveView(
  ...
  /*
   * Телефон — виды прототипа «Кабинет 2026»: «Команда», «День», «Неделя».
   *
   * Все три — списком, а не сеткой: на 390 pt двадцатиминутный визит в сетке
   * суток превращается в полоску, в которую не попасть пальцем. «Команда» —
   * повестка дня всех, кого видно, «День» — одного человека, «Неделя» —
   * неделя списком. Открывается командой у того, кто её видит, иначе днём.
   *
