...
/**
 * Тонкий root-провайдер мира Luxury (§8.2): единственный dynamic boundary
 * композиции. С шага M4 мир обслуживает собственный чанк — алиас на soft
 * снят (burn-down в TASKS.md).
 */
export default function LuxuryRoot({ children }: { children: ReactNode }) {
  return (
    <CompositionProvider styleKey="luxury" composition={composition}>
      {children}
    </CompositionProvider>
  );
}
