 ...
 *
 * Алиасы — только временное состояние миграции (§8.3): minimal, luxury,
 * editorial, organic и neo-glass ещё не приземлились и работают на
 * soft-композиции (чанк общий). У каждого алиаса стоит шаг, который его
 * снимает (П5–П9 / M3–M7 — burn-down в TASKS.md); конечное состояние —
 * семь собственных композиций.
 */
const ROOTS: Record<BrandStyleKey, CompositionRootComponent> = {
  ...
  luxury: dynamic(() => import('../compositions/soft/root')),
