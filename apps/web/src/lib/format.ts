...
/**
 * Длительность визита словами: «1 ч 15 мин», а не «75 мин».
 *
 * Один форматтер на продукт, и живёт он здесь, а не в движке публичной
 * страницы, потому что спрашивают его трое: шторка записи, страница статуса и
 * кабинет клиента. Первая говорила «1 ч 15 мин», двое других печатали
 * «75 мин» и «195 мин» — одна и та же запись читалась по-разному на соседних
 * экранах, и «195 мин» человек всё равно переводит в часы в уме.
 *
 * Единицы приходят из словаря. Зашитые «мин» и «ч» заставляли латышскую
 * страницу читать «1 ч 15 мин» посреди латышского всего остального — утечка,
 * которая обнаруживается только на языке, на котором не проверяют.
 *
 * Кабинет мастера намеренно остаётся при минутах: там длительность не читают,
 * а вводят, и поле подписано «Длительность, мин» — «1 ч 15 мин» рядом с ним
 * спорило бы с собственной подписью.
 */
