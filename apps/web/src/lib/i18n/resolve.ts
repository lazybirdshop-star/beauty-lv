 ...
 *
 * Deliberately not exported from `index.tsx`: that module is `'use client'`,
 * and a function re-exported from it becomes a client reference the server
 * cannot call — the admin layout failed to prerender for exactly that reason.
 */
